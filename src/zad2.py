...
class Library:
    ...
    def __str__(self) -> str:
        return f"Library(city={self.city}, street={self.street}," \
            f"zip_code={self.zip_code}, open_hours={self.open_hours}" \
            f"phone={self.phone})"
...
class Employee:
    ...
    def __str__(self) -> str:
        return f"Employee(first_name={self.first_name}, " \
            f"last_name={self.last_name}, hire_date={self.hire_date}, " \
            f"birth_date={self.birth_date}, city={self.city}, " \
...
class Book:
    ...
    def __str__(self) -> str:
        return f"Book(library={str(self.library)}, " \
...
class Order:
    ...
    def __str__(self) -> str:
        ...
        return f"Order(employee={str(self.employee)}, " \
            f"student={self.student}, books={books}, " \
            f"order_date={self.order_date})"


if __name__ == "__main__":
    l1 = Library(
        "Katowice", "Bogucicka", "40-215", "8:00 - 16:00", "+48 012 345 678"
    )

    l2 = Library(
        "Rybnik", "Gliwicka", "44-220", "7:00 - 14:00", "+48 987 654 321"
    )
    ...
    e1 = Employee("Bartosz", "Dziewit", "17.07.2018", "14.01.1986",
                  "Sosnowiec", "Katowicka", "41-180", "+48 111 222 333")

    e2 = Employee("Adam", "Małysz", "10.11.2002", "18.11.1972", "Szczecin",
                  "Poznanska", "54-318", "+48 123 649 832")

    e3 = Employee("Jan", "Paweł", "08.02.2024", "14.01.1920", "Wadowice",
                  "Szeroka", "24-070", "+48 900 601 320")
